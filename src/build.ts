...
export default class Build{
    ...
    private result:String=new String();
    // private design:Design=new Design();
    // private color:any=this.design.getColors();
    private active={
      isShowCase:false,
      isNavbar:true,
      isSectionOne:false,
    ...
    private buildInput:BuildInput=new BuildInput();
    public setBuilding(create:Create){
      ...
      this.result=this.body.navBar.concat(
        this.body.showCase,
        this.body.firstSection,
        this.body.secondSection,
        this.body.thirdSection,
        this.body.footer);
